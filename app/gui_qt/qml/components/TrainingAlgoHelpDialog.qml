...
Dialog {
    ...
    readonly property var azProxySections: [
        ...
        { icon: "◆", title: "Режимы инференса",
          text: "• Greedy — быстро, без search;\n• MCTS — в интерфейсе так же называется, но внутри это не полный Tree-MCTS; ожидайте поведение ближе к search-lite." },
        { icon: "✦", title: "Температура",
