...
AZ_FIELD_TOOLTIPS: dict[str, str] = {
    ...
    "reward_shaping_weight": "Сила dense reward-shaping (0=выкл). Плотный per-step сигнал «иди на точку» из env-наград (objective-progress/proximity) при relaxed outcome_only. Сильнее mission_bootstrap. Рекомендация: 0.3–0.5.",
