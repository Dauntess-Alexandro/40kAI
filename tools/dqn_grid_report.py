#!/usr/bin/env python3
"""Summarize DQN grid search lines from artifacts/results/results.txt."""
...
def main(top_k: int = 5) -> int:
    ...
    ok_lines = [ln for ln in lines if "[DQN_GRID] ok" in ln]
    print(f"DQN grid OK runs: {len(ok_lines)}")
