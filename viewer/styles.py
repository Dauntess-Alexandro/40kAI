...
class Theme:
    ...
    demo_command = QtGui.QColor("#d7b66f")
    demo_move = QtGui.QColor("#7fbf7f")
    demo_shoot = QtGui.QColor("#c4935a")
    demo_charge = QtGui.QColor("#d16666")
    demo_fight = QtGui.QColor("#9a75d6")
