...
def self_check_render_model_log_flat() -> str:
    sample_events = [
        {
            "side": "enemy",
            "battle_round": 1,
            ...
            "type": "move",
            "msg": "Позиция до: (6, 0). Выбор: right, advance=да, бросок=4, макс=9, distance=6",
            "data": {},
        },
        {
            "side": "enemy",
        ...
        },
        {
            ...
            "unit_name": "Necron Warriors",
            "type": "skip",
            "msg": "Advance без Assault — стрельба пропущена.",
            "data": {},
        },
    ]
    return render_model_log_flat(sample_events)
