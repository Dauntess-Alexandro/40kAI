...
- [ ] **Оптимизировать чтение `response.txt` в state export**  
...
- [ ] **Снизить объём `model_events` в `state.json`**  
...
- [ ] **Ограничить частоту тяжёлых state flush в GUI**  
...
- [ ] **Убрать частые open/write/close для `gui/response.txt`**  
...
- [ ] **Снизить нагрузку от train-логирования в файл**  
...
- [ ] **Проверить частоту checkpoint-save**  
...
- [ ] **Разделить “лёгкий” и “полный” state payload**  
  Лёгкий — для частых GUI-обновлений (позиции/HP/фаза), полный — реже (логи/события).

- [ ] **Сделать профилирование I/O по категориям**  
