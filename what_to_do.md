...
3) Демонстрация хода ИИ по фазам (сценарий/тайминг) — НЕ СМОГЛИ СДЕЛАТЬ, ПОКА ПРОПУСКАЕМ
...
4) Слои UI на карте (movement/shooting/objectives) — СДЕЛАНО
...
5) Логи и UX (структура вкладок + ключевые события) — СДЕЛАНО
...
6) «Кинематографический» визуал (glow/halo/пульсация) - СДЕЛАНО
...
7) Эффекты боя (вспышка, трассеры) - СДЕЛАНО
