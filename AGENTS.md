...
- В корне проекта есть файл **LOGS_FOR_AGENTS.txt** — это “источник правды” по тому, что реально происходило во время игры/GUI.
- При любом баге/неожиданном поведении:
  1) **сначала прочитай свежие строки** из `LOGS_FOR_AGENTS.txt`,
