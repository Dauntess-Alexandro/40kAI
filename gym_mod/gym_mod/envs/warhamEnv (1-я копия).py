                        ...
                        while response == False:
                            ...
                            if is_num(shoot) == True and int(shoot)-21 in shootAble:
                                ...
                                if self.modelStrat["smokescreen"] != -1 and self.modelStrat["smokescreen"] == idOfE:
                                    ...
                                    effect = None
                                dmg, modHealth = attack(self.enemy_health[i], self.enemy_weapon[i], self.enemy_data[i], self.unit_health[idOfE], self.unit_data[idOfE], effects = effect, roller=player_dice)
