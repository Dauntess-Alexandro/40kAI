...
The app has 4 tabs that are called "Training", "Model Metrics", "Play", and "Settings".
...
<p align="center">
    ...
    <br>Figure 2: A representation of the "Model Metrics" tab
</p>

In the second tab called "Model Metrics" (shown in Figure 2) displays training metrics that help track model progress.
